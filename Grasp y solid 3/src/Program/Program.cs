...
namespace Full_GRASP_And_SOLID
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            IDestinoimperison impersion1 = new Imprimirenconsola();
            IDestinoimperison impersion2 = new Impresionarchivo();
            impersion2.Imprimir(recipe);
            impersion1.Imprimir(recipe);
        }
